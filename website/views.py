...
@login_required
def bird():
    return render_template('findbird.html', user=current_user)
...
def predictbird():
    ...
    return render_template("findbird.html", prediction=classification, image_loc=imagefile.filename, user=current_user)
